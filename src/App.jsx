        ...
        <div className="flex gap-6 sm:gap-10">
          <button
            ...
            className={`transition-colors font-bold ${
              activeTab === "home"
                ? "text-bash-yellow"
                : "text-bash-text hover:text-bash-green"
            }`}
          >
            home
          </button>
      ...
      <main className="flex-1">
        ...
        {activeTab === "home" && (
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="max-w-2xl text-bash-text leading-relaxed">
              ...
              <p>
                I am a{" "}
                <span className="text-bash-text border-b border-bash-yellow">
                  Backend Software Engineer
                </span>{" "}
                and{" "}
                <span className="text-bash-text border-b border-bash-yellow">
                  SWE Intern at Joylane
                </span>
                , specializing in backend systems and API development.
              </p>
              <p>
              ...
              <p>
                I collaborate effectively on frontend development with{" "}
                <strong>React.js</strong> and <strong>React Native</strong>,
                enabling full-stack delivery for Joylane's{" "}
                <strong>video commerce platform</strong>.
              </p>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="border border-bash-green p-6 sm:p-10 relative bg-[#0c0f0c]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <h3 className="text-bash-yellow border-b border-bash-text/20 pb-1 mb-3 inline-block font-bold">
                      --tech_stack--
                    </h3>
                    <ul className="text-bash-text text-sm space-y-2 font-mono">
                      {/* Languages */}
                      <li className="flex items-start">
                        <span className="text-bash-green font-bold shrink-0 mr-2">
                          &gt; Languages:
                        </span>
                        <span>
                      ...
                      <li className="flex items-start">
                        ...
                        <span>
                          Google Cloud Platform, Compute Engine (Linux VM),
                          Docker
                        </span>
                      </li>
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-2 text-sm">
                      <a
                        href="https://github.com/SonarAkash"
                        target="_blank"
                        className="text-bash-cyan hover:underline"
                      >
                        Github
                      </a>
                      <a
                        href="https://linkedin.com/in/sonar-akash"
                        target="_blank"
                        className="text-bash-cyan hover:underline"
                      >
                        LinkedIn
                      ...
                      <a
                        href="https://leetcode.com/Akash_Sonar/"
                        target="_blank"
                        className="text-bash-cyan hover:underline"
                      >
                ...
                <div className="mt-12 pt-4 border-t border-dashed border-bash-text/20 text-xs text-bash-text font-mono">
                  ...
                  >
                    <span className="text-bash-green">$</span> curl
                    akash.sh/projects &nbsp;&nbsp;&nbsp;&nbsp;
                    <span className="opacity-50 group-hover:text-bash-cyan transition-colors">
                      # View source code
                    </span>
                  </button>
        ...
        {activeTab === "projects" && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="text-bash-text mb-2 text-xs sm:text-sm opacity-70">
              $ <span className="text-bash-green">curl</span> akash.sh/projects
              --json | jq .
            </div>
            ...
            <div className="border border-bash-border overflow-hidden">
              ...
              <div className="grid grid-cols-12 border-b border-bash-border bg-[#111] text-bash-yellow font-bold text-xs sm:text-sm uppercase tracking-wider">
                <div className="col-span-1 p-3 text-center border-r border-bash-border hidden sm:block">
                  ID
                </div>
                <div className="col-span-12 sm:col-span-4 p-3 border-r border-bash-border">
                  Project
                </div>
                <div className="col-span-12 sm:col-span-5 p-3 border-r border-bash-border">
                  Description
                </div>
                <div className="col-span-12 sm:col-span-2 p-3 text-center">
                  Links
                </div>
              </div>
              ...
              <div className="grid grid-cols-12 border-b border-bash-text/10 hover:bg-bash-green/5 transition-colors text-xs sm:text-sm group bg-bash-green/5">
                <div className="col-span-1 p-3 text-center border-r border-bash-text/10 text-bash-yellow hidden sm:block font-bold">
                  —
                </div>
                <div className="col-span-12 sm:col-span-4 p-3 border-r border-bash-text/10 font-bold text-bash-yellow">
                  Joylane · SWE Intern
                  <div className="mt-1 text-xs text-bash-orange font-normal opacity-90">
                    [TypeScript, GraphQL, PostgreSQL, React Native]
                  </div>
                </div>
              ...
              <div className="grid grid-cols-12 border-b border-bash-text/10 hover:bg-bash-green/5 transition-colors text-xs sm:text-sm group">
                <div className="col-span-1 p-3 text-center border-r border-bash-text/10 text-bash-text/50 hidden sm:block group-hover:text-white">
                  01
                </div>
                <div className="col-span-12 sm:col-span-4 p-3 border-r border-bash-text/10 font-bold text-bash-green">
                  Log Management System
                  <div className="mt-1 text-xs text-bash-orange font-normal opacity-80">
                    [Java, Spring Boot, Docker]
                  </div>
                </div>
                <div className="col-span-12 sm:col-span-5 p-3 border-r border-bash-text/10 text-bash-text group-hover:text-white">
                  Real-time log ingestion & analysis platform. Uses PostgreSQL
                  Full-Text Search for high-speed querying.
                </div>
                <div className="col-span-12 sm:col-span-2 p-3 flex items-center justify-center gap-2">
                  <a
                    href="https://github.com/SonarAkash/Log-Management-and-Analysis-System"
                    target="_blank"
              ...
              <div className="grid grid-cols-12 border-b border-bash-text/10 hover:bg-bash-green/5 transition-colors text-xs sm:text-sm group">
                ...
                <div className="col-span-12 sm:col-span-4 p-3 border-r border-bash-text/10 font-bold text-bash-green">
                  ...
                  <div className="mt-1 text-xs text-bash-orange font-normal opacity-80">
                    [Spring Boot, Redis, RBAC]
                  </div>
                </div>
                <div className="col-span-12 sm:col-span-5 p-3 border-r border-bash-text/10 text-bash-text group-hover:text-white">
                  Secure blog backend with JWT auth, Role-Based Access Control,
                  and Redis caching for performance.
                </div>
                <div className="col-span-12 sm:col-span-2 p-3 flex items-center justify-center gap-2">
                  <a
                    href="https://github.com/SonarAkash/blog-platform"
                    target="_blank"
                    className="text-bash-cyan hover:underline decoration-2"
                  >
                    repo
              ...
              <div className="grid grid-cols-12 border-b border-bash-text/10 hover:bg-bash-green/5 transition-colors text-xs sm:text-sm group">
                ...
                <div className="col-span-12 sm:col-span-4 p-3 border-r border-bash-text/10 font-medium text-bash-green/90">
                  FreeFlow P2P Chat
                  <div className="mt-1 text-xs text-bash-orange font-normal opacity-60">
                    [WebRTC, WebSockets]
                  </div>
                </div>
                <div className="col-span-12 sm:col-span-5 p-3 border-r border-bash-text/10 text-bash-text/80 group-hover:text-white">
                  Video & chat application. Built the Signaling Server to manage
                  peer handshakes.
                </div>
                <div className="col-span-12 sm:col-span-2 p-3 flex items-center justify-center gap-2">
                  <a
                    href="https://github.com/SonarAkash/FreeFlow"
                    target="_blank"
                    className="text-bash-cyan hover:underline decoration-2"
                  >
                    repo
              ...
              <div className="grid grid-cols-12 hover:bg-bash-green/5 transition-colors text-xs sm:text-sm group">
                ...
                <div className="col-span-12 sm:col-span-5 p-3 border-r border-bash-text/10 text-bash-text/80 group-hover:text-white">
                  Browser add-on that auto-summarizes emails using Google's
                  Gemini AI model.
                </div>
                <div className="col-span-12 sm:col-span-2 p-3 flex items-center justify-center gap-2">
                  <a
                    href="https://github.com/SonarAkash/gmail-summarizer-addon"
                    target="_blank"
                    className="text-bash-cyan hover:underline decoration-2"
                  >
                    repo
        ...
        {activeTab === "contact" && (
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="text-bash-text">
              <p>
                Currently{" "}
                <span className="text-bash-yellow">SWE Intern at Joylane</span>{" "}
                (video commerce). Open to{" "}
                <span className="text-bash-yellow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              {/* Direct Channels */}
              <div>
                <h3 className="text-xl text-bash-yellow mb-4 font-bold border-b border-bash-text/20 pb-2 inline-block">
                  Direct Channels
                </h3>
                <div className="space-y-4">
                  <div>
                    ...
                    <a
                      href="mailto:akashsonar.9113@gmail.com"
                      className="text-bash-cyan text-lg hover:underline"
                    >
                      akashsonar.9113@gmail.com
                    </a>
                  </div>
                  <div>
                    <div className="text-xs text-bash-text/50 mb-1">
                      LINKEDIN
                    </div>
                    <a
                      href="https://linkedin.com/in/sonar-akash"
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <a
                      href="https://leetcode.com/Akash_Sonar/"
                      target="_blank"
                      className="text-bash-text hover:text-bash-cyan transition-colors"
                    >
                      LeetCode{" "}
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    >
                      GitHub{" "}
                      <span className="text-bash-orange ml-2">[Active]</span>
                    </a>
                  </li>
                </ul>
