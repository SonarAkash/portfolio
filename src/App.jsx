        ...
        {activeTab === 'home' && (
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="max-w-2xl text-bash-text leading-relaxed">
              <p className="mb-4">
                <span className="text-bash-green font-bold">&gt; whoami</span>
              </p>
              <p>
            ...
            <div className="mt-12">
              ...
              <div className="border border-bash-green p-6 sm:p-10 relative bg-[#0c0f0c]">
                ...
                <div className="mb-8 font-black text-4xl sm:text-6xl text-bash-yellow tracking-tighter leading-none">
                  BUILT TO
                  <br />
                  <span className="text-bash-green">SCALE_</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div>
                 ...
                 <div className="mt-8 pt-6 border-t border-bash-text/10">
                   <a href="/resume.pdf" download className="inline-flex items-center gap-2 border border-bash-green text-bash-green px-6 py-3 hover:bg-bash-green hover:text-black transition-colors font-bold">
